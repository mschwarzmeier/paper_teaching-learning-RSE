...
The following paragraphs summarize established online resources and service providers for RSE training.
A longer list of more specialized online resources and resource databases can be found in
[Various resources for RSE-related training].
...
- material for self-study [@Fogel2005], [@Irving2021], [@Wilson2019a]

#### Making resources FAIR and continuously updated
...
Likewise, published works like [@Fogel2005] was released in its
second edition as a living document [@Fogel2017], and the ENCCS instructor
